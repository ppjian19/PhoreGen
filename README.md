...
<div style="text-align: center;">     <img src="./assets/generation demo.gif" alt="generation" width="70%"/> </div>
...
<div style="text-align: center;">     <img src="./assets/MBL-SBL demo.gif" alt="model" width="70%"/> </div>
