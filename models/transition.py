...
import numpy as np
from .common import categorical_kl, extract, index_to_log_onehot, log_1_min_a, \
                log_add_exp, log_categorical, log_sample_categorical, to_torch_const
...
class ContigousTransition(nn.Module):
    ...
    def get_prev_from_recon(self, x_t, x_recon, t, batch, energy_grad=0.):
        ...
        mu = coef_x0 * x_recon + coef_xt * x_t - energy_grad
